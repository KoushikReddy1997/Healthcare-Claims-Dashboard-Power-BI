...
# Writing a funciton that can be applied to all checks for every variable
...
# Check In-Correct data formats(zeros or presence of one data type in another )


# In[9]:


# Data Entry errors (typos, sepllings, captials)
